...
if __name__ == "__main__":
    ...
    #Load model
    irl_model = torch.load('./noisey_features/models/dropout/'+str(worldtype)+'_'+str(dropout_val)+'_'+str(num_paths)+'_NF_model_'+str(index_features_to_corrupt)+'.pth') 
    
    '''
    #Load noisey feature data
    open_file = open("./noisey_features/featuredata/dropout/"+str(worldtype)+'_'+str(dropout_val)+'_'+str(num_paths)+"_feature_data_"+str(index_features_to_corrupt)+".pkl", "rb")
    ...
    file_name = RESULTS_PATH+str(worldtype)+'_'+str(dropout_val)+'_'+str(num_paths)+'_results_'+str(index_features_to_corrupt)+'.pkl'
