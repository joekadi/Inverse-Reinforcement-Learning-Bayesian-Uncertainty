...
filename = 'ow_'+str(num_paths)+'_results_'+str(index_states_to_remove)+'.mat'
mat = scipy.io.loadmat('/Users/joekadi/Documents/University/5thYear/Thesis/Code/MSci-Project/pyTorch/total_uncertainty/results/gpirl/'+filename)
...
RESULTS_PATH = "./total_uncertainty/results/gpirl/"
