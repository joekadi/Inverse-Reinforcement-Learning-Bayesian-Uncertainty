...
if __name__ == "__main__":
    ...
    model.index_features_to_corrupt = index_states_to_corrupt
    ...
    TRAINED_MODELS_PATH = "./noisey_features/models/dropout/"
    ...
    torch.save(model.model, TRAINED_MODELS_PATH+str(worldtype)+'_'+str(dropout_val)+'_'+ str(num_paths)+ '_NF_model_'+str(index_states_to_corrupt)+'.pth') 
