...
open_file = open('/Users/joekadi/Documents/University/5thYear/Thesis/Code/MSci-Project/pyTorch/total_uncertainty/results/ensembles/'+filename, "rb")
...
file_name = RESULTS_PATH+'ow_0.0_'+str(num_paths)+'_resultsproper_'+str(index_states_to_remove)+'.pkl'
