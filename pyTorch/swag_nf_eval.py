...
if __name__ == "__main__":
    ...
    #Load state dict
    irl_model.load_state_dict(torch.load('./noisey_features/models/swag/'+str(worldtype)+'_'+str(dropout_val)+'_'+str(num_paths)+ '_NF_model_'+str(index_states_to_remove)+'.pth'))
