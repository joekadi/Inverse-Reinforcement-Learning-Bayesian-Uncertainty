...
if __name__ == "__main__":
    ...
    #Load model
    irl_model = torch.load('./total_uncertainty/models/dropout/'+str(worldtype)+'_'+str(dropout_val)+'_'+str(num_paths)+ '_total_model_'+str(index_states_to_remove)+'.pth') 
    ...
    RESULTS_PATH = "./total_uncertainty/results/dropout/"
