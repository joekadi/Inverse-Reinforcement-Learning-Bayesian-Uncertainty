...
from mcd_train import LitModel
...
if __name__ == "__main__":
    ...
    #Load model
    #irl_model.load_state_dict(torch.load('./noisey_paths/models/swag/'+str(worldtype)+'_'+str(dropout_val)+'_'+str(num_paths)+ '_NP_model_'+str(index_states_to_remove)+'.pth'))
    ...
    irl_model = torch.load('./regular/models/dropout/'+str(worldtype)+'_'+str(dropout_val)+'_'+str(num_paths)+ '_REG_model.pth') 
    
    num_preds = 2000 # Number of samples
    ...
    RESULTS_PATH = "./regular/results/dropout/"
