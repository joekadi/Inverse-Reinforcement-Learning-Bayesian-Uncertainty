...
if __name__ == "__main__":
   ...
   # Remove chosen states from paths
    ...
    TRAINED_MODELS_PATH = "./total_uncertainty/models/swag/"
    ...
    torch.save(swa_model.state_dict(), TRAINED_MODELS_PATH+str(worldtype)+'_'+str(dropout_val)+'_'+ str(len(example_samples))+'_total_model_'+str(index_states_to_remove)+'.pth') 
