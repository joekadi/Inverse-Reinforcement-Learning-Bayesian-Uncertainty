...
if __name__ == "__main__":
    ...
    TRAINED_MODELS_PATH = "./regular/models/swag/"
    ...
    torch.save(swa_model.state_dict(), TRAINED_MODELS_PATH+str(worldtype)+'_'+str(dropout_val)+'_'+ str(len(example_samples))+'_REG_model.pth') 
