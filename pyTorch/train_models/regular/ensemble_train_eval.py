...
if __name__ == "__main__":
    ...
    results = [y_mc_relu, y_mc_std_relu, y_mc_relu_reward, y_mc_relu_v, y_mc_relu_P, y_mc_relu_q, NLL.calculate_EVD(truep, y_mc_relu_reward), 10, 5,000]

    #Save results
    print('\n... saving results ...\n')

    # Create path for trained models
    RESULTS_PATH = "./regular/results/ensembles/"
    ...
    file_name = RESULTS_PATH+str(worldtype)+'_'+str(0.0)+'_'+ str(num_paths)+ '_results.pkl'
