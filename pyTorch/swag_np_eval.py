...
if __name__ == "__main__":
    ...
    #Load state dict
    irl_model.load_state_dict(torch.load('./noisey_paths/models/realswag/'+str(worldtype)+'_'+str(dropout_val)+'_'+str(num_paths)+ '_NP_model_'+str(index_states_to_remove)+'.pth'))
    ...
    RESULTS_PATH = "./noisey_paths/results/realswag/"
