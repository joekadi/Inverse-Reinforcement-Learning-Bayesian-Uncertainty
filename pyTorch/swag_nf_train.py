...
if __name__ == "__main__":
    ...
    model.index_states_to_remove = index_states_to_corrupt
    ...
    TRAINED_MODELS_PATH = "./noisey_features/models/swag/"
    ...
    torch.save(swa_model.state_dict(), TRAINED_MODELS_PATH+str(worldtype)+'_'+str(dropout_val)+'_'+ str(len(example_samples))+'_NF_model_'+str(index_states_to_corrupt)+'.pth') 
