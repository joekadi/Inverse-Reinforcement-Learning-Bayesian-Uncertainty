...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        print('Index of states to remove now supplied')
    ...
    if len(sys.argv) > 3:
        ...
        raise Exception("Num paths not provided")
    ...
    #Load state dict
    irl_model.load_state_dict(torch.load('./total_uncertainty/models/swag/'+str(worldtype)+'_'+str(dropout_val)+'_'+str(num_paths)+ '_total_model_' + str(index_states_to_remove) + '.pth'))
    ...
    RESULTS_PATH = "./total_uncertainty/results/swag/"
